...
export default {
	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				'hero-gradient': 'linear-gradient(135deg, hsl(var(--hero-gradient-start)), hsl(var(--hero-gradient-middle)), hsl(var(--hero-gradient-end)))',
				'health-gradient': 'linear-gradient(135deg, hsl(var(--health-primary)), hsl(var(--health-primary-light)))'
			},
			backdropBlur: {
				xs: '2px',
			}
